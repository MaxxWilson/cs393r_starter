...
num_particles = 200 -- Prof recommends ~50

-- TODO Tune these from odometry messages and sampling time
k1 = 0.5 -- translation error from translation
k2 = 0.0 -- translation error from rotation
k3 = 0.2 -- rotation error from translation
k4 = 0.0 -- rotation error from rotation
...
gamma = 1/200               -- TODO Experimental tuning
