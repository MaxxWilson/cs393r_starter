...
-- Motion Model Params --
k1 = 1.0   -- x error from translation         -- 95% of translations are within 15% margin of error
k2 = 0.0   -- x error from rotation            -- This is effectively zero given the small angle approx
k3 = 0.5   -- y error from translation         -- This is effectively zero given the small angle approx
...
gamma = 0.035 -- 0.01                -- TODO Experimental tuning

-- Limits maximum weight error --
-- Increasing these makes it harsher on short/long errors for scan
dist_short = 0.25   -- 1 std from sensor 68.2%
dist_long = 0.25     -- 2 std from sensor 95%

resample_frequency = 5     -- TODO Experimental tuning
...
theta_search_range = 0.2
dist_search_range = 0.15
